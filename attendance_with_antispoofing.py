...
def login():
                            ...
                            if post_var.get() == "" or fname_var.get() == "" or gender_var.get() ==  "" or contact_var.get() == "" or address_var.get() == "":
                                ...
                                if (re.search('[a-zA-Z]+', fname_var.get())):
                                    if len(contact_var.get()) != 10:
                                        ...
                                        if (re.search('^[7-9]\d{9}$', contact_var.get())):
                                            regex = '^(\w|\.|\_|\-)+[@](\w|\_|\-|\.)+[.]\w{2,3}$'
    ...
    ######################################### Function to recognize the face
                ...
                attendance.geometry("1530x790+0+0")
                bg_image = PhotoImage(file="Photos/bg14.png", master = attendance)
                ...
                manage = 'FACE RECOGNITION ATTENDANCE SYSTEM'
                topic = Label(attendance, text = manage ,fg = "white",bg="darkblue", padx = 15, pady = 15, font = ("Times New Roman", 25, "bold") ,borderwidth = 5, relief = RIDGE)
                topic.place (x = 0, y = 0,relwidth = 1)
                # faceslider()
                # faceslidercolor()

                photo1 = PhotoImage(file = "Photos/icon1.png", master = attendance)
                B1 = Button(attendance, image = photo1,command = manage_employee)
                B1.place(x = 200, y = 150,height =220, width = 220)

                b1_1 = Button(attendance,command=manage_employee,text="Employee Details",font=("times new roman",15,"bold"),bg="darkblue",fg="white")
                b1_1.place(x=200,y=350,width=220,height=50)



                photo2 = PhotoImage(file = "Photos/icon6.png",  master = attendance)
                B2 = Button(attendance, image = photo2,command = photo_samples)
                B2.place(x = 500, y= 150,height =220, width = 220)

                b2_1 = Button(attendance,command=photo_samples,text = "Photo Samples",font=("times new roman",15,"bold"),bg="darkblue",fg="white")
                b2_1.place(x=500,y=350,width=220,height=50)

                photo3 = PhotoImage(file = "Photos/embeddings.png", master = attendance)
                B3 = Button(attendance, image = photo3,command = face_embedding)
                B3.place(x = 800, y =150,height =220, width = 220)

                b3_1 = Button(attendance,command=face_embedding,text="Extract Embeddings",font=("times new roman",15,"bold"),bg="darkblue",fg="white")
                b3_1.place(x=800,y=350,width=220,height=50)

                photo4 = PhotoImage(file = "Photos/icon5.png",  master = attendance)
                B4 = Button(attendance, image = photo4,command = train)
                B4.place(x = 1100, y = 150,height =220, width = 220)

                b4_1 = Button(attendance,command=train,text="Train Data",font=("times new roman",15,"bold"),bg="darkblue",fg="white")
                b4_1.place(x=1100,y=350,width=220,height=50)


                photo5 = PhotoImage(file = "Photos/icon2.png",  master = attendance)
                B5 = Button(attendance, image = photo5,command = face_recognize)
                B5.place(x = 200, y = 450,height =220, width = 220)

                b5_1 = Button(attendance,command=face_recognize,text="Face Recognizer",font=("times new roman",15,"bold"),bg="darkblue",fg="white")
                b5_1.place(x=200,y=650,width=220,height=50)

                photo6 = PhotoImage(file = "Photos/icon3.png" ,  master = attendance)
                B6 = Button(attendance, image = photo6,command = report)
                B6.place(x = 500, y = 450,height =220, width = 220)

                b6_1 = Button(attendance,command=report,text="Attendance Report",font=("times new roman",15,"bold"),bg="darkblue",fg="white")
                b6_1.place(x=500,y=650,width=220,height=50)

                photo7 = PhotoImage(file = "Photos/password2.png", master = attendance)
                B7 = Button(attendance, image = photo7,command = change)
                B7.place(x = 800, y = 450,height =220, width = 220)

                b7_1 = Button(attendance,command=change,text="Admin Account",font=("times new roman",15,"bold"),bg="darkblue",fg="white")
                b7_1.place(x=800,y=650,width=220,height=50)

                photo8 = PhotoImage(file = "Photos/icon8.png",  master = attendance )
                B8 = Button(attendance, image = photo8,command = exit)
                B8.place(x =1100, y = 450,height =220, width = 220)  

                b8_1 = Button(attendance,command=exit,text="Exit",font=("times new roman",15,"bold"),bg="darkblue",fg="white")
                b8_1.place(x=1100,y=650,width=220,height=50)          
...
bg_icon = PhotoImage(file = "Photos/bg15.png", master = face)
background_image = Label(face, image = bg_icon)
background_image.pack()

title = Label(face, text = "Admin Login Page" , font = ("times new roman", 30, "bold"), bg = "slateblue", fg = "white", bd = 7, relief = GROOVE) 
title.place(x = 0, y = 0, relwidth = 1)

clock = Label(face , font = ("times",20,"bold"), bg = "white", relief = GROOVE)
clock.place(x = 1200, y= 700,width=250)
tick()
login_frame= Frame(face, bg = "slateblue" )
login_frame.place(x = 600, y = 200)
