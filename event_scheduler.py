...
def send_mail():
    ...
    server.starttls()
    server.login('sushilkumardhepe12@gmail.com','kmjfbvnjsvlfputw')
    for email in absent_staff_emails:
        server.sendmail('sushilkumardhepe12@gmail.com',
                    email,
                    'You are absent')
    ...
    msg['From'] = 'sushilkumardhepe12@gmail.com'
    ...
    with smtplib.SMTP_SSL('smtp.gmail.com',465) as smtp:
        smtp.login('sushilkumardhepe12@gmail.com','kmjfbvnjsvlfputw')
...
sched.add_job(send_mail,'cron',day_of_week='mon-sun', hour=15, minute=23)
sched.start()
